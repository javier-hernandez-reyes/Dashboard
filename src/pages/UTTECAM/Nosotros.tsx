            ...
            {editingSection === 'objetivoIntegral' ? (
              ...
              <div>
                <p className="text-gray-700 leading-relaxed whitespace-pre-line">
                  {content.objetivoIntegral && content.objetivoIntegral.text && content.objetivoIntegral.text.trim() !== '' ? content.objetivoIntegral.text : 'Contenido no disponible'}
                </p>
                <Button
                  onClick={() => handleEdit('objetivoIntegral', content.objetivoIntegral?.text || '')}
                  variant="outline"
                  size="sm"
                  className="mt-4"
                >
