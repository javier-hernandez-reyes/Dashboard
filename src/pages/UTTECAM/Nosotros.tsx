                ...
                {imageErrors.politicaIntegral && (
                  <div className="flex items-center justify-center bg-red-50 rounded-lg border-2 border-red-200 p-8">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-red-600 mb-4">No se pudo cargar la imagen. Verifique que el backend esté ejecutándose en localhost:3002 y tenga CORS configurado correctamente.</p>
                      <button
                        onClick={() => {
