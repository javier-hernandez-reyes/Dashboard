                ...
                {pdfs.map((pdf) => (
                  <div key={pdf.id} className="flex items-center justify-between p-3 border rounded-lg gap-2">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <button onClick={() => handlePdfView(pdf)} className="p-2 rounded hover:bg-gray-50" title="Ver">
                        <Eye size={16} />
                      </button>
                      <button onClick={() => handlePdfDownload(pdf)} className="p-2 rounded hover:bg-gray-50" title="Descargar">
                        <Download size={16} />
                      </button>
                      <button onClick={() => setConfirmDeletePdfId(pdf.id)} className="p-2 rounded hover:bg-red-50 text-red-600" title="Eliminar">
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
