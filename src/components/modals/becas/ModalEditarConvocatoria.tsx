...
export const ModalEditarConvocatoria = ({ isOpen, onClose, section, onSave }: ModalEditarConvocatoriaProps) => {
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
                <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center sticky top-0 bg-white dark:bg-gray-800 z-10">
                    <h2 className="text-xl font-bold text-gray-800 dark:text-white">
                        {section.id === 0 ? 'Nueva Sección de Convocatoria' : 'Editar Convocatoria'}
                    </h2>
